...
function DeckSwiper(_a) {
    ...
    var rotateAndTranslate = (0, react_native_reanimated_1.useAnimatedStyle)(function () {
        var rotate = (0, react_native_reanimated_1.interpolate)(translateX.value, [-cardWidth / 2, 0, cardWidth / 2], [-10, 0, 10], react_native_reanimated_1.Extrapolation.CLAMP) + 'deg';
        return {
            transform: [
                { rotate: rotate },
    ...
    var nextCardAnimatedStyle = (0, react_native_reanimated_1.useAnimatedStyle)(function () {
        var opacity = (0, react_native_reanimated_1.interpolate)(translateX.value, [-cardWidth / 2, 0, cardWidth / 2], [1, 0, 1], react_native_reanimated_1.Extrapolation.CLAMP);
        var scale = (0, react_native_reanimated_1.interpolate)(translateX.value, [-cardWidth / 2, 0, cardWidth / 2], [1, 0.8, 1], react_native_reanimated_1.Extrapolation.CLAMP);
        return __assign({ opacity: opacity, transform: [{ scale: scale }] }, react_native_1.StyleSheet.absoluteFillObject);
    });
    ...
    var panGesture = (0, react_1.useMemo)(function () { return react_native_gesture_handler_1.Gesture.Pan()
        ...
        if (event.translationX > swipeThreshold) {
            translateX.value = (0, react_native_reanimated_1.withSpring)(cardWidth + 100, undefined, function (isFinished) {
                if (isFinished)
                    (0, react_native_reanimated_1.runOnJS)(handleSwipeRight)();
            });
            translateY.value = (0, react_native_reanimated_1.withSpring)(event.translationY);
        }
            ...
            translateX.value = (0, react_native_reanimated_1.withSpring)(0, { damping: 10 });
            translateY.value = (0, react_native_reanimated_1.withSpring)(0, { damping: 10 });
        }
